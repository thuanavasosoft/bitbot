...
class BreakoutBot {
  ...
  private _verifyEnvs() {
    const necessaryEnvKeys = [
      ...
      "BREAKOUT_BOT_SIGNAL_N",
      "BREAKOUT_BOT_SIGNAL_ATR_LEN",
      "BREAKOUT_BOT_SIGNAL_K",
      "BREAKOUT_BOT_SIGNAL_EPS",
      "BREAKOUT_BOT_SIGNAL_M_ATR",
      "BREAKOUT_BOT_SIGNAL_ROC_MIN",
      "BREAKOUT_BOT_SIGNAL_EMA_PERIOD",
      "BREAKOUT_BOT_SIGNAL_NEED_TWO_CLOSES",
      "BREAKOUT_BOT_SIGNAL_VOL_MULT",
